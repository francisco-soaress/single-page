...
?>
    ...
    <section class="container main_menu">
        ...
        <nav>
            <h3 class="fontzero">Menu de navegação</h3>
            <ul>
                <li><a href="<?= $master; ?>#go_home">Home</a></li>
                <li><a href="<?= $master; ?>#go_about">Sobre</a></li>
                <li><a href="<?= $master; ?>#go_services">Serviços</a></li>
                <li><a href="<?= $master; ?>blog">Blog</a></li>
                <li><a href="<?= $master; ?>#go_testimony">Depoimentos</a></li>
                <li><a href="<?= $master; ?>#go_costumers">Clientes</a></li>
                <li><a href="<?= $master; ?>#go_contact">Contato</a></li>
            </ul>
        </nav>
        <div class="clear"></div>
    </section>
